...
public class Preguntas {
    ...
    private String pregunta_obligatoria;
    ...
    @Generated
    public Preguntas(Long pregunta_id, Integer encuesta_id, String pregunta_obligatoria, String pregunta_encabezado, String pregunta_tipo, Integer tipo_min, Integer tipo_max, String tipo_dato) {
        this.pregunta_id = pregunta_id;
    ...
    public String getPregunta_obligatoria() {
        return pregunta_obligatoria;
    }

    public void setPregunta_obligatoria(String pregunta_obligatoria) {
        this.pregunta_obligatoria = pregunta_obligatoria;
    }
